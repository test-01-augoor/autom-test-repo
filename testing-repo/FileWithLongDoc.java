...
public class DecimalToAnyUsingStack {
  ...
  /**
   * This is a paragraph to test long documentations
   *
   * Writing a long documentation we will see if the new feature works as expected
   * new feature works as expected
   * new feature works as expected?
   * new feature works as expected!
   * looks like new feature works as expected
   * I think new feature works as expected
   *
   * Writing a long documentation we will see if the new feature works as expected
   * new feature works as expected
   * new feature works as expected?
